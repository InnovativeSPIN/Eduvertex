    ...
    <div className="animate-in fade-in duration-500">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        {projects.map((project) => (
          <div key={project.id} className="bg-card border border-border rounded-xl overflow-hidden group">
            ...
            <div className="p-5">
              <div className="flex items-start justify-between mb-3">
                <div>
                  ...
                  <StudentBadge variant={getStatusVariant(project.status)} className="mt-1">
